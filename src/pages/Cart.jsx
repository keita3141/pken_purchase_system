            ...
            <div className="grid md:grid-cols-2 gap-3 md:gap-4">
                  ...
                  return (
                    <div key={item.id} className="bg-white rounded-lg shadow-sm p-2">
                      <div className="flex gap-2">
                        {/* Product Image */}
                        <Link to={`/product/${product.id}`} className="w-16 bg-stone-200 rounded flex-shrink-0 flex items-center justify-center overflow-hidden aspect-square">
                          {productImage ? (
                        ...
                        <div className="flex-1 min-w-0 flex flex-col justify-between">
                          <div>
                            <Link to={`/product/${product.id}`} className="font-bold text-xs text-stone-800 hover:text-stone-600 block truncate">
                              {productName}
                            </Link>
              ...
              <div className="md:col-span-1">
                <div className="bg-white rounded-lg shadow-sm p-4 md:p-6 md:sticky md:top-4">
                  ...
                  <button
                    className="w-full bg-stone-800 hover:bg-stone-700 text-white font-bold py-6 px-4 rounded-lg transition-colors text-sm md:text-base"
                    onClick={() => alert('購入機能はまだ実装されていません')}
                  >
                    購入手続きへ
                  </button>

                  <Link to="/" className="block text-center link-text mt-3 md:mt-4 text-sm md:text-base py-6">
                    買い物を続ける
                  </Link>
                </div>
              </div>
